...
"""
            ...
            df = pd.DataFrame(records)
            carpeta = r"C:\DataAnalysis\Eurostat\datafilecsv"  # Ruta carpeta ficheros
            nombre_archivo = os.path.join(carpeta, f"prc_hicp_manr_{vCodeGeo}_{vCodeIDCOICOP}_{fecha_actual}.csv")  # Crear el nombre del archivo con la fecha y configurar la ruta
